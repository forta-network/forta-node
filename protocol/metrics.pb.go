...
func (x *AgentMetrics) GetMetrics() []*MetricSummary {
	if x != nil {
		return x.Metrics
	}
	return nil
...
type MetricSummary struct {
	...
	P95     float64 `protobuf:"fixed64,6,opt,name=p95,proto3" json:"p95,omitempty"`
}
...
func (x *AgentMetric) GetTimestamp() string {
	if x != nil {
		return x.Timestamp
	}
	return ""
...
func (x *AgentMetric) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *AgentMetric) GetValue() float64 {
	if x != nil {
		return x.Value
	}
	return 0
...
type AgentMetricList struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Metrics []*AgentMetric `protobuf:"bytes,1,rep,name=Metrics,proto3" json:"Metrics,omitempty"`
}

func (x *AgentMetricList) Reset() {
	*x = AgentMetricList{}
	if protoimpl.UnsafeEnabled {
...
func (x *AgentMetricList) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AgentMetricList) ProtoMessage() {}

func (x *AgentMetricList) ProtoReflect() protoreflect.Message {
	mi := &file_metrics_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AgentMetricList.ProtoReflect.Descriptor instead.
func (*AgentMetricList) Descriptor() ([]byte, []int) {
	return file_metrics_proto_rawDescGZIP(), []int{3}
}

func (x *AgentMetricList) GetMetrics() []*AgentMetric {
	if x != nil {
		return x.Metrics
	}
	return nil
...
var file_metrics_proto_rawDesc = []byte{
	...
	,
	...
	0x20, 0x01, 0x28, 0x01, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x47, 0x0a, 0x0f, 0x41,
	0x67, 0x65, 0x6e, 0x74, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x34,
	...
	0x72, 0x69, 0x63, 0x73, 0x42, 0x0d, 0x5a, 0x0b, 0x2e, 0x2f, 0x3b, 0x70, 0x72, 0x6f, 0x74, 0x6f,
