...
// PoolVersion is a free data retrieval call binding the contract method 0x6a693719.
//
// Solidity: function poolVersion(bytes32 ) view returns(uint256)
func (_AgentRegistry *AgentRegistryCaller) PoolVersion(opts *bind.CallOpts, arg0 [32]byte) (*big.Int, error) {
	var out []interface{}
	err := _AgentRegistry.contract.Call(opts, &out, "poolVersion", arg0)
...
//
// Solidity: function poolVersion(bytes32 ) view returns(uint256)
func (_AgentRegistry *AgentRegistrySession) PoolVersion(arg0 [32]byte) (*big.Int, error) {
	return _AgentRegistry.Contract.PoolVersion(&_AgentRegistry.CallOpts, arg0)
}

// PoolVersion is a free data retrieval call binding the contract method 0x6a693719.
//
// Solidity: function poolVersion(bytes32 ) view returns(uint256)
func (_AgentRegistry *AgentRegistryCallerSession) PoolVersion(arg0 [32]byte) (*big.Int, error) {
	return _AgentRegistry.Contract.PoolVersion(&_AgentRegistry.CallOpts, arg0)
}
