...
// AddScannerAsOwner is a paid mutator transaction binding the contract method 0x5be0cfb6.
//
// Solidity: function addScannerAsOwner(address _scanner) returns()
func (_ScannerRegistry *ScannerRegistryTransactor) AddScannerAsOwner(opts *bind.TransactOpts, _scanner common.Address) (*types.Transaction, error) {
	return _ScannerRegistry.contract.Transact(opts, "addScannerAsOwner", _scanner)
}

// AddScannerAsOwner is a paid mutator transaction binding the contract method 0x5be0cfb6.
//
// Solidity: function addScannerAsOwner(address _scanner) returns()
func (_ScannerRegistry *ScannerRegistrySession) AddScannerAsOwner(_scanner common.Address) (*types.Transaction, error) {
	return _ScannerRegistry.Contract.AddScannerAsOwner(&_ScannerRegistry.TransactOpts, _scanner)
}

// AddScannerAsOwner is a paid mutator transaction binding the contract method 0x5be0cfb6.
//
// Solidity: function addScannerAsOwner(address _scanner) returns()
func (_ScannerRegistry *ScannerRegistryTransactorSession) AddScannerAsOwner(_scanner common.Address) (*types.Transaction, error) {
	return _ScannerRegistry.Contract.AddScannerAsOwner(&_ScannerRegistry.TransactOpts, _scanner)
}
